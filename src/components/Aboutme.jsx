...
const AboutMe = () => {
  return (
    <>
      <div className="bg-gray-900 py-8 px-4 md:px-20 lg:px-40">
        <motion.div
              ...
              >
                <a href="https://linkedin.com/in/ashutosh2004" target="_blank" rel="noopener noreferrer">
                  <div className="p-4 bg-white rounded-full hover:bg-gray-300 transition-colors duration-300">
                    <FaLinkedin className="text-black hover:text-gray-700 hover:scale-150 transition-transform duration-300" size={24} />
                  </div>
                </a>
                <a href="mailto:ashutoshpanda.india@gmail.com">
                  <div className="p-4 bg-white rounded-full hover:bg-gray-300 transition-colors duration-300">
                    <FaEnvelope className="text-black hover:text-gray-700 hover:scale-150 transition-transform duration-300" size={24} />
                  </div>
                </a>
                <a href="https://github.com/Ashutosh-Panda2004" target="_blank" rel="noopener noreferrer">
                  <div className="p-4 bg-white rounded-full hover:bg-gray-300 transition-colors duration-300">
                    <FaGithub className="text-black hover:text-gray-700 hover:scale-150 transition-transform duration-300" size={24} />
                  </div>
                </a>
              </motion.div>
            </motion.div>
